require "functions"
local recipe = getUpgradeRecipe("electric-mining-drill")

if data.raw.module["green-module-5"] then
	table.insert(recipe.ingredients,{"green-module-5", 1})
...
elseif data.raw.module["effectivity-module-5"] then
	table.insert(recipe.ingredients,{"effectivity-module-5", 1})
	...
	table.insert(recipe.ingredients,{"effectivity-module-3", 1})
	table.insert(data.raw["technology"]["fast-drills"].prerequisites,"effectivity-module-3")
end

if data.raw.item["diamond-4"] then
	table.insert(recipe.ingredients,{"diamond-4", 2})
