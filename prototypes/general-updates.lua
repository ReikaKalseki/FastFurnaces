...
if Config.modules then
	if Config.freeUseModules then
		...
		data.raw.module["productivity-module-4"].limitation = productivity_module_limitation()
		data.raw.module["productivity-module-4"].limitation_message_key = "production-module-usable-only-on-intermediates"
		
		data.raw.module["productivity-module-5"].limitation = productivity_module_limitation()
